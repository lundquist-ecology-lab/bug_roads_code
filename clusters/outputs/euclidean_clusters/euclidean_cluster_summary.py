...
# File paths
distance_files = [
    "euclidean_clusters_100m.csv",
    "euclidean_clusters_250m.csv",
    "euclidean_clusters_500m.csv",
    "euclidean_clusters_1000m.csv"
]
shapes_gpkg = "../../../data/open_and_park_single_26918.gpkg"
boroughs_gpkg = "../../../data/borough_boundaries_26918.gpkg"
output_file = "euclidean_analysis_results.txt"
