...
def main():
    ...
    cluster_dir = Path("../../clusters/outputs/dijkstra_clusters")
    output_path = "../outputs/vegetation_dijkstra_cluster_fixed_results.csv"
    ...
    cluster_files = list(cluster_dir.glob("dijkstra_clusters_*.csv"))
